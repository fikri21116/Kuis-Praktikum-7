...
lyr_Roads_2.set('fieldLabels', {'full_id': 'header label - visible with data', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'name': 'no label', });
lyr_BusStop_3.set('fieldLabels', {'name': 'no label', 'highway': 'no label', 'Foto': 'header label - visible with data', });
